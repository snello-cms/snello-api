...
public class MetadataController {
    ...
    public HttpResponse<?> createTable(@NotNull String uuid) throws Exception {
    ...
    @Get(UUID_PATH_PARAM_DELETE)
    public HttpResponse<?> deleteTable(@NotNull String uuid) throws Exception {
