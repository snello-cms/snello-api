...
import io.snello.cms.model.events.ConditionCreateUpdateEvent;
import io.snello.cms.model.events.ConditionDeleteEvent;
...
@Controller(AppConstants.CONDITIONS_PATH)
public class ConditionsController {
    ...
    static String table = AppConstants.CONDITIONS;
